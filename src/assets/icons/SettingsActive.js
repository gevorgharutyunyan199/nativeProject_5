        ...
        <Svg width={width?width:75} height={height?height:49} viewBox="0 0 75 49">
            ...
            <G fill="none" fillRule="evenodd">
                <G>
                    ...
                    <Use fill="url(#tjofhvow5b)" transform="rotate(-90 37.5 19.5)" xlinkHref="#ro1xmb2lja"/>
                </G>
            </G>
        </Svg>
    )
